...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		// 2. approve non fungible - without ItemI
		...
		{"nonFungibleToken", false, false, "Mint non fungible token - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "", "", "", "TNFT", "acc-40", "nft-mostafa", "", "112233", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},                     //ok
		{"nonFungibleToken", false, true, "Remint non fungible token - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "", "", "", "TNFT", "acc-40", "nft-mostafa", "", "112233", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},                    //ok
		{"nonFungibleToken", false, false, "Mint non fungible token - (mint for burn) Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "", "", "", "TNFT", "acc-40", "nft-yk", "", "223344", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},          //ok
		{"nonFungibleToken", false, false, "Mint non fungible token - (mint for endorsement) Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "", "", "", "TNFT", "acc-40", "nft-nago", "", "334455", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil}, //ok
		...
		{"nonFungibleToken", false, false, "Mint (by Public==TRUE) non fungible token(TNFT-public-01) - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "", "", "", "TNFT-public-01", "acc-40", "acc-40", "token metadata", "223344", "properties", "metadata", true, false, false, true, true, "", "", "", "", "", "", "", []string{""}}, "Mint (by Public==TRUE) non fungible token(TNFT-public-01) - Happy path", nil},
		...
		{"nonFungibleToken", false, false, "MINT non fungible item [Item-MD1] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-MD1", "acc-40", "nft-mostafa", "token metadata", "Item-MD1", "properties", "metadata", true, false, false, true, false, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		...
		{"nonFungibleToken", false, false, "MINT non fungible item [Item-MD2] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-MD2", "acc-40", "nft-mostafa", "token metadata", "Item-MD2", "properties", "metadata", true, false, false, false, false, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		...
		{"nonFungibleToken", false, false, "endorse a nonfungible item - Happy path", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT", "nft-carlo", "", "token metadata", "334455", "", "", true, false, false, true, false, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		...
		{"nonFungibleToken", true, true, "endorse a nonfungible item - Invalid Token Symbol", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT-111", "nft-carlo", "", "token metadata", "334455", "properties", "metadata", true, false, false, false, false, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", true, true, "endorse a nonfungible item - Invalid Item-ID", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT", "nft-carlo", "", "token-metadata", "999111", "properties", "metadata", true, false, false, false, false, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},

		// 5. transfer non fungible item - with ItemID
		{"nonFungibleToken", true, true, "Transfer non fungible token item - invalid owner", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-bob", "nft-mostafa", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item from mostafa to mostafa- Happy path", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-mostafa", "nft-mostafa", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item from mostafa to yk - Happy path", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
	//	{"nonFungibleToken", false, true, "Retransfer non fungible token item from mostafa to yk", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item from yk to bob - Happy path", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-yk", "nft-bob", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item from bob to mostafa- Happy path", "nft-bob", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-bob", "nft-mostafa", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", true, true, "Transfer non fungible token item from mostafa to yk - limit exceeded", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", true, true, "Transfer non fungible token item - Invalid Item-ID", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "999111", "properties", "metadata", true, false, false, false, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "MINT non fungible item [Item-PUBLIC-FALSE] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-PUBLIC-FALSE", "acc-40", "nft-mostafa", "token metadata", "Item-PUBLIC-FALSE", "properties", "metadata", true, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "endorse a nonfungible item [Item-PUBLIC-FALSE] - Happy path", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT-PUBLIC-FALSE", "nft-carlo", "", "token metadata", "Item-PUBLIC-FALSE", "", "", true, false, true, true, false, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item [Item-PUBLIC-FALSE] - Happy path", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT-PUBLIC-FALSE", "nft-mostafa", "nft-yk", "token metadata", "Item-PUBLIC-FALSE", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Burn non fungible token item [Item-PUBLIC-FALSE] - Happy path", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT-PUBLIC-FALSE", "nft-yk", "", "token metadata", "Item-PUBLIC-FALSE", "", "", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", true, true, "Reburn non fungible token item", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT-PUBLIC-FALSE", "nft-yk", "", "token metadata", "Item-PUBLIC-FALSE", "", "", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", true, true, "Transfer burned item", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT-PUBLIC-FALSE", "nft-yk", "nft-mostafa", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", true, true, "MINT non fungible token [Item-PUBLIC-TRUE] - Error, Public token can only be minted to itself. ", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "", "", "", "TNFT-PUBLIC-TRUE", "acc-40", "nft-yk", "token metadata", "Item-PUBLIC-TRUE", "properties", "metadata", true, false, true, true, true, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "MINT non fungible item [Item-PUBLIC-TRUE] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-PUBLIC-TRUE", "acc-40", "acc-40", "token metadata", "Item-PUBLIC-TRUE", "properties", "metadata", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "endorse a nonfungible item [Item-PUBLIC-TRUE] - Happy path", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT-PUBLIC-TRUE", "nft-carlo", "", "token metadata", "Item-PUBLIC-TRUE", "", "", true, false, true, true, true, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item [Item-PUBLIC-TRUE] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT-PUBLIC-TRUE", "acc-40", "nft-yk", "token metadata", "Item-PUBLIC-TRUE", "properties", "metadata", true, false, true, true, true, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Burn non fungible token item [Item-PUBLIC-TRUE] - Happy path", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT-PUBLIC-TRUE", "nft-yk", "", "token metadata", "Item-PUBLIC-TRUE", "", "", true, false, true, true, true, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "MINT non fungible item [Item-PUBLIC-TRUE-2] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-PUBLIC-TRUE-2", "acc-40", "acc-40", "token metadata", "Item-PUBLIC-TRUE-2", "properties", "metadata", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "endorse a nonfungible item [Item-PUBLIC-TRUE-2] - Happy path", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT-PUBLIC-TRUE-2", "nft-carlo", "", "token metadata", "Item-PUBLIC-TRUE-2", "", "", true, false, true, true, true, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item [Item-PUBLIC-TRUE-2] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT-PUBLIC-TRUE-2", "acc-40", "nft-yk", "token metadata", "Item-PUBLIC-TRUE-2", "properties", "metadata", true, false, true, true, true, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Burn non fungible token item [Item-PUBLIC-TRUE-2] - Happy path", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT-PUBLIC-TRUE-2", "nft-yk", "", "token metadata", "Item-PUBLIC-TRUE-2", "", "", true, false, true, true, true, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "MINT non fungible item [Item-PUBLIC-TRUE-3] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-PUBLIC-TRUE-3", "acc-40", "acc-40", "token metadata", "Item-PUBLIC-TRUE-3", "properties", "metadata", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "1", "1", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", true, true, "MINT non fungible item [Item-PUBLIC-TRUE-3] - Error due to MINT limit existed.", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-PUBLIC-TRUE-3", "acc-40", "acc-40", "token metadata", "Item-PUBLIC-TRUE-3", "properties", "metadata", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "1", "1", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "endorse a nonfungible item [Item-PUBLIC-TRUE-3] - Happy path", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT-PUBLIC-TRUE-3", "nft-carlo", "", "token metadata", "Item-PUBLIC-TRUE-3", "", "", true, false, true, true, true, "", "", "", "", "", "1", "1", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", false, false, "Transfer non fungible token item [Item-PUBLIC-TRUE-3] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT-PUBLIC-TRUE-3", "acc-40", "acc-40", "token metadata", "Item-PUBLIC-TRUE-3", "properties", "metadata", true, false, true, true, true, "", "", "", "", "", "1", "1", []string{""}}, "", nil},
		{"nonFungibleToken", true, true, "Transfer non fungible token item [Item-PUBLIC-TRUE-3] - Error due to TRANSFER limit existed.", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT-PUBLIC-TRUE-3", "acc-40", "acc-40", "token metadata", "Item-PUBLIC-TRUE-3", "properties", "metadata", true, false, true, true, true, "", "", "", "", "", "1", "1", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "Burn non fungible token item [Item-PUBLIC-TRUE-3] -  Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT-PUBLIC-TRUE-3", "acc-40", "", "token metadata", "Item-PUBLIC-TRUE-3", "", "", true, false, true, true, true, "", "", "", "", "", "1", "1", []string{""}}, "", nil},

		// 6. burn non fungible item - with ItemID
		{"nonFungibleToken", true, true, "Burn non fungible token item - Invalid token owner", "nft-carlo", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT", "nft-carlo", "", "token metadata", "223344", "", "", false, false, false, false, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		{"nonFungibleToken", false, false, "Burn non fungible token item -  Happy path", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT", "nft-yk", "", "token metadata", "223344", "", "", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", true, true, "Burn non fungible token item - Invalid Item-ID", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT", "nft-yk", "", "token metadata", "999111", "", "", false, false, false, false, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "Transfer non fungible token ownership - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"transfer-ownership", "", "", "", "TNFT", "acc-40", "nft-yk", "token metadata", "", "", "", false, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "Approve non fungible token transfer ownership - Happy path for TNFT", "nft-mostafa", "0cin", 0, NonFungibleTokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "", "", "", true, false, false, true, false, "nft-jeansoon", "0", "nft-carlo", "", "APPROVE_TRANFER_TOKEN_OWNERSHIP", "", "", []string{""}}, "", nil},

		// 9. accept token ownership - without ItemID
		{"nonFungibleToken", false, false, "Accept non fungible token ownership - Happy path. commit", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"accept-ownership", "", "", "", "TNFT", "", "nft-yk", "token metadata", "", "", "", false, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", false, false, "MINT non fungible item [TNFT-special01] - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint", "10000000", "nft-mostafa", "TestNonFungibleToken", "TNFT-special01", "acc-40", "nft-mostafa", "token metadata", "661122", "properties", "metadata", true, true, true, true, false, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},              //ok
		...
		{"nonFungibleToken", false, false, "Burn non fungible token item [TNFT-special01] -  Happy path", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"burn", "", "", "", "TNFT-special01", "nft-mostafa", "", "token metadata", "661122", "", "", true, true, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},                                                                                                                //ok
