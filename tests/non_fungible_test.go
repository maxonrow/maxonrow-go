...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"nonFungibleToken", true, true, "Reject non fungible token [TNFT-REJ1] - Error, Token does not exist as already been rejected before.", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"reject", "0", "nft-mostafa", "TestNonFungibleToken", "TNFT-REJ1", "acc-40", "", "token metadata", "", "", "", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil}, //[Re-action]
		...
		{"nonFungibleToken", false, true, "Remint non fungible token - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint-item", "", "", "", "TNFT", "acc-40", "nft-mostafa", "", "112233", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},                    //[Re-action]
		...
		{"nonFungibleToken", true, true, "Approve non fungible token transfer ownership - Error due to transfer token ownership has been approved.", "nft-mostafa", "0cin", 0, NonFungibleTokenInfo{"verify-transfer-token-ownership", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "", "", "", true, false, false, true, false, "nft-jeansoon", "0", "nft-carlo", "", "APPROVE_TRANFER_TOKEN_OWNERSHIP", "", "", []string{""}}, "", nil}, // [Re-action]
