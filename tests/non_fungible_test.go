...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"nonFungibleToken", false, true, "Update NFT Metadata non fungible token - Invalid token-symbol.", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"update-nft-metadata", "0", "nft-mostafa", "TestNonFungibleToken", "TNFT-UPDATE-METADATA", "acc-40", "", "token metadata updated here by goh 003", "", "", "", false, false, false, false, false, "", "", "", "", "", "", "", []string{""}}, "", nil}, //ok
		...
		{"nonFungibleToken", false, true, "endorse a nonfungible item - Invalid endorser", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"endorsement", "", "", "", "TNFT", "nft-yk", "", "token metadata", "778899", "properties", "metadata", true, false, false, false, false, "", "", "", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},               // ok
		...
		{"nonFungibleToken", false, true, "Freeze non fungible item [TNFT-D2] - Invalid signer.", "nft-jeansoon", "100000000cin", 0, NonFungibleTokenInfo{"freeze-item", "10000000", "", "", "TNFT-D2", "nft-jeansoon", "", "token metadata", "880099", "", "", true, false, false, false, false, "nft-jeansoon", "1", "nft-carlo", "", "", "", "", []string{""}}, "", nil},                //ok
		...
		{"nonFungibleToken", false, true, "Freeze non fungible item [TNFT-D2] - Not authorised to freeze non token item.", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"freeze-item", "10000000", "", "", "TNFT-D2", "nft-yk", "", "token metadata", "880099", "", "", true, false, false, false, false, "nft-jeansoon", "1", "nft-carlo", "", "", "", "", []string{""}}, "", nil},   //ok
		{"nonFungibleToken", false, true, "Freeze non fungible item [TNFT-D2] - Non Fungible item already frozen.", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"freeze-item", "10000000", "", "", "TNFT-D2", "nft-mostafa", "", "token metadata", "880099", "", "", true, true, false, false, false, "nft-jeansoon", "1", "nft-carlo", "", "", "", "", []string{""}}, "", nil}, //ok
