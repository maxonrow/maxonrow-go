...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"nonFungibleToken", true, true, "Reject non fungible token [TNFT-REJ1] - Error, Token does not exist as already been rejected before.", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"reject", "0", "nft-mostafa", "TestNonFungibleToken", "TNFT-REJ1", "acc-40", "", "token metadata", "", "", "", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil}, //ok
		...
		{"nonFungibleToken", false, true, "Reject non fungible token [TNFT-REJ2] - Error, Not allowed to reject as Token already approved.", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"reject", "0", "nft-mostafa", "TestNonFungibleToken", "TNFT-REJ2", "acc-40", "", "token metadata", "", "", "", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},  // ???goh20200220
		...
		{"nonFungibleToken", false, true, "Remint non fungible token - Happy path", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint-item", "", "", "", "TNFT", "acc-40", "nft-mostafa", "", "112233", "properties", "metadata", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},                    //ok
		...
		{"nonFungibleToken", false, true, "Mint non fungible token - Token item id is in used.", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"mint-item", "", "", "", "TNFT", "acc-40", "nft-mostafa", "", "112233", "properties", "metadata", true, false, false, false, false, "", "", "", "", "", "", "", []string{""}}, "", nil},     //ok
		{"nonFungibleToken", false, true, "Mint non fungible token - Invalid token minter.", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"mint-item", "", "", "", "TNFT", "nft-yk", "nft-mostafa", "", "112233", "properties", "metadata", true, false, false, false, false, "", "", "", "", "", "", "", []string{""}}, "", nil},         //ok
		...
		//	{"nonFungibleToken", false, true, "Retransfer non fungible token item from mostafa to yk", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer-item", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", true, true, "Reburn non fungible token item", "nft-yk", "100000000cin", 0, NonFungibleTokenInfo{"burn-item", "", "", "", "TNFT-PUBLIC-FALSE", "nft-yk", "", "token metadata", "Item-PUBLIC-FALSE", "", "", true, false, true, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", true, true, "Approve non fungible token transfer ownership - Error due to transfer token ownership has been approved.", "nft-mostafa", "0cin", 0, NonFungibleTokenInfo{"verify-transfer-token-ownership", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "", "", "", true, false, false, true, false, "nft-jeansoon", "0", "nft-carlo", "", "APPROVE_TRANFER_TOKEN_OWNERSHIP", "", "", []string{""}}, "", nil},
		...
		{"nonFungibleToken", true, true, "Reject-transfer non fungible token ownership [TNFT-REJ-TF1] - Error, Token does not exist as already been rejected-transfer-token-ownership before.", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"reject-transfer-token-ownership", "0", "nft-mostafa", "TestNonFungibleToken", "TNFT-REJ-TF1", "nft-yk", "", "token metadata", "", "", "", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
