...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"nonFungibleToken", false, false, "Approve non fungible token(TNFT) : TransferLimit(2) Mintlimit(2) Endorser(nft-jeanson,nft-carlo) - Happy path", "nft-mostafa", "0cin", 0, NonFungibleTokenInfo{"approve", "", "", "TestNonFungibleToken", "TNFT", "", "", "", "", "properties", "metadata", false, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "default", "", "2", "2", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		...
		{"nonFungibleToken", false, false, "Transfer non fungible token item - Happy path", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
