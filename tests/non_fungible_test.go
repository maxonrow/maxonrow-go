...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"nonFungibleToken", true, true, "Update NFT endorserlist [TNFT-validate-update-endorserlist-001]- Error due to Invalid token owner.", "acc-29", "100000000cin", 0, NonFungibleTokenInfo{"update-nft-endorserlist", "", "", "TestNonfungibleToken-validate-update-endorserlist-001", "TNFT-validate-update-endorserlist-001", "", "", "", "", "item-properties", "item-metadata", false, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "default", "", "4", "10000000", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		{"nonFungibleToken", true, true, "Update NFT endorserlist [TNFT-validate-update-endorserlist-001]- Error due to existed of Endorser is not whitelisted.", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"update-nft-endorserlist", "", "", "TestNonfungibleToken-validate-update-endorserlist-001", "TNFT-validate-update-endorserlist-001", "", "", "", "", "item-properties", "item-metadata", false, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "default", "", "4", "10000000", []string{"nft-jeansoon", "nft-carlo", "nft-acc-notKYC"}}, "", nil},
		{"nonFungibleToken", false, false, "Update NFT endorserlist [TNFT-validate-update-endorserlist-001]- Happy Path. commit", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"update-nft-endorserlist", "", "", "TestNonfungibleToken-validate-update-endorserlist-001", "TNFT-validate-update-endorserlist-001", "", "", "", "", "item-properties", "item-metadata", false, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "default", "", "4", "10000000", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
		...
		{"nonFungibleToken", true, true, "Update NFT endorserlist [TNFT-validate-update-endorserlist-001]- Error due to token was freeze", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"update-nft-endorserlist", "", "", "TestNonfungibleToken-validate-update-endorserlist-001", "TNFT-validate-update-endorserlist-001", "", "", "", "", "item-properties", "item-metadata", false, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "default", "", "4", "10000000", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},

		// 2.3 update-nft-endorserlist : Challenge endorserlist
		{"nonFungibleToken", false, false, "Create non fungible token [TNFT-validate-update-endorserlist-002]- Happy path, commit.", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"create", "10000000", "nft-mostafa", "TestNonfungibleToken-validate-update-endorserlist-002", "TNFT-validate-update-endorserlist-002", "acc-40", "", "token metadata", "Item1233", "item-properties", "item-metadata", false, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "Create non fungible token - Happy path, commit.", nil},
		{"nonFungibleToken", true, true, "Update NFT endorserlist [TNFT-validate-update-endorserlist-002]- Error due to token yet to approved", "acc-40", "100000000cin", 0, NonFungibleTokenInfo{"update-nft-endorserlist", "", "", "TestNonfungibleToken-validate-update-endorserlist-002", "TNFT-validate-update-endorserlist-002", "", "", "", "", "item-properties", "item-metadata", false, false, true, true, false, "nft-jeansoon", "0", "nft-carlo", "default", "", "4", "10000000", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},
