...
func makeNonFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"nonFungibleToken", true, true, "Reject non fungible token [TNFT-REJ2] - Error, Not allowed to reject as Token already approved.", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"reject", "0", "nft-mostafa", "TestNonFungibleToken", "TNFT-REJ2", "acc-40", "", "token metadata", "", "", "", true, false, true, true, true, "nft-jeansoon", "0", "nft-carlo", "", "", "", "", []string{"nft-jeansoon", "nft-carlo"}}, "", nil},   // ???goh20200220
		...
		{"nonFungibleToken", true, true, "Retransfer non fungible token item from mostafa to yk", "nft-mostafa", "100000000cin", 0, NonFungibleTokenInfo{"transfer-item", "", "", "", "TNFT", "nft-mostafa", "nft-yk", "token metadata", "112233", "properties", "metadata", true, false, false, true, false, "", "", "", "", "", "", "", []string{""}}, "", nil},
