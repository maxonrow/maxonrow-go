...
func makeFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		// case-1 : Dynamic-supply where MaxSupply="0" and FixedSupply = FALSE and allowed to mint-token with any amount u like
		{"token", false, false, "Create token TFT-1101 - Happy Path", "acc-40", "100000000cin", 0, TokenInfo{"create", "100000", "mostafa", "TestToken-1101", "TFT-1101", 8, "acc-40", "", "", false, "1000", false, false, false, "", "", "", "", "", ""}, "", nil},
		{"token", false, false, "Approve token TFT-1101 - for Dynamic-supply purpose.", "token-auth-1", "0cin", 0, TokenInfo{"approve", "", "", "TestToken-1101", "TFT-1101", 0, "", "", "", false, "1000", false, false, true, "0", "token-prov-1", "0", "token-issuer-1", "default", ""}, "", nil},
		{"token", false, false, "Mint token TFT-1101 - Dynamic-supply which allowed to mint-token with any amount.", "acc-40", "100000000cin", 0, TokenInfo{"mint", "", "", "TestToken-1101", "TFT-1101", 8, "acc-40", "carlo", "", false, "1000", false, false, true, "111", "", "", "", "", ""}, "", nil},
		{"token", true, true, "Mint token TFT-1101 - Error due to current TotalSupply > MaxSupply.", "acc-40", "100000000cin", 0, TokenInfo{"mint", "", "", "TestToken-1101", "TFT-1101", 8, "acc-40", "carlo", "", false, "1000", false, false, true, "99999", "", "", "", "", ""}, "", nil},

		// case-2 : FixedSupply where MaxSupply!="0" & FixedSupply = TRUE, is not allowed to do mint-token
