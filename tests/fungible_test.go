...
func makeFungibleTokenTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"token", true, true, "Mint token TFT-774 for Dynamic-supply - Error due to Invalid token owner", "acc-29", "100000000cin", 0, TokenInfo{"mint", "", "", "TestToken-774-name", "TFT-774", 8, "acc-29", "carlo", "", false, "0", false, false, true, "0", "", "", "", "", ""}, "", nil},
		...
		{"token", false, false, "Approve token transfer ownership TFT-775 - Happy path", "token-auth-1", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TFT-775", 0, "", "", "", true, "", true, false, true, "", "token-prov-1", "0", "token-issuer-1", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		...
		{"token", true, true, "Approve transfer token ownership (FT-NEW01) - Error due to Invalid token action because of Token is frozen.", "token-auth-2", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "FT-NEW01", 0, "", "", "", false, "", false, false, true, "", "token-prov-2", "0", "token-issuer-2", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		...
		{"token", false, false, "Mint token TFT-1401                                 .", "acc-40", "100000000cin", 0, TokenInfo{"mint", "", "", "", "TT-1", 8, "acc-40", "gohck", "", false, "", false, false, false, "100", "", "", "", "", ""}, "", nil},
		{"token", true, true, "Transfer token - Error, Insufficient fee amount               ", "gohck", "100000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "gohck", "nago", "", false, "", true, true, false, "1000000000000000", "", "", "", "", ""}, "", nil},
		{"token", false, false, "Transfer token - Sufficient fee balance              ", "gohck", "10000000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "gohck", "nago", "", false, "", true, true, false, "100", "", "", "", "", ""}, "", nil},
		{"token", false, false, "Transfer token - transfer to own                     ", "nago", "100000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "nago", "nago", "", false, "", true, true, false, "10", "", "", "", "", ""}, "", nil},
		{"token", true, true, "Transfer token - Error, transfer to own not enought balance  ", "nago", "100000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "nago", "nago", "", false, "", true, true, false, "101", "", "", "", "", ""}, "", nil},
		{"token", false, false, "Transfer token - transfer to gohck                   ", "nago", "100000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "nago", "gohck", "", false, "", true, true, false, "10", "", "", "", "", ""}, "", nil},
		{"token", true, true, "Transfer token - Error, transfer to gohck not enought balance", "nago", "100000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "nago", "gohck", "", false, "", true, true, false, "100", "", "", "", "", ""}, "", nil},
		{"token", true, true, "Transfer token - Error, transfer by alice due to Invalid token account", "alice", "100000000cin", 0, TokenInfo{"transfer", "", "", "", "TT-1", 8, "alice", "gohck", "", false, "", true, true, false, "100", "", "", "", "", ""}, "", nil},
		...
		{"token", false, false, "Approve token transfer ownership - Happy path for TT-1", "token-auth-1", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TT-1", 0, "", "", "", true, "", true, false, true, "", "token-prov-1", "0", "token-issuer-1", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		...
		{"token", true, true, "Approve transfer token ownership - Error for TT-6 due to Invalid Authorised Signer", "eve", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TT-6", 0, "", "", "", false, "", true, false, false, "", "token-prov-2", "0", "token-issuer-1", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		{"token", true, true, "Approve transfer token ownership - Error for TT-6 due to Invalid Token Provider", "token-auth-1", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TT-6", 0, "", "", "", false, "", true, false, false, "", "eve", "0", "token-issuer-1", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		{"token", true, true, "Approve transfer token ownership - Error for TT-6 due to Invalid Token Issuer", "token-auth-1", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TT-6", 0, "", "", "", false, "", true, false, false, "", "token-prov-2", "0", "eve", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		// try again with the valid scenarios
		{"token", false, false, "Approve transfer token ownership - Happy-path for TT-6", "token-auth-2", "0cin", 0, TokenInfo{"verify-transfer-tokenOwnership", "", "", "", "TT-6", 0, "", "", "", false, "", true, false, false, "", "token-prov-2", "0", "token-issuer-2", "", "APPROVE_TRANSFER_TOKEN_OWNERSHIP"}, "", nil},
		...
		{"token", true, true, "Create token - Error due to Invalid signer", "nft-acc-notKYC", "100000000cin", 0, TokenInfo{"create", "10000000", "mostafa", "TestToken-validate01", "TFT-validate01", 8, "nft-acc-notKYC", "", "", true, "100000", false, false, false, "", "", "", "", "", ""}, "", nil},
