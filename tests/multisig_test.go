...
func makeMultisigTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"multiSig", true, true, "case-2-Transfer MultiSig Owner - Error, due to without KYC                                                                          ", "multisig-nokyc", "800400000cin", 0, MultisigInfo{"transfer-ownership", "multisig-acc-1", "multisig-nokyc", 0, nil, "grp-addr-4", 0, nil}, "MEMO : Transfer MultiSig Owner.", nil}, //
		...
		{"multiSig", true, true, "case-3-Sign MultiSig Tx - Error, due to All signers must pass kyc.                 ", "multisig-nokyc", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : Sign MultiSig Tx", nil}, // ok-20200317
		...
		{"multiSig", true, true, "case-3-Sign MultiSig Tx - Error, multisig-acc-2 is not group account's signer after Update.", "multisig-acc-2", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : Sign MultiSig Tx", nil}, // ok-20200317
		...
		{"multiSig", true, true, "case-3-Transfer MultiSig Owner - Error, due to without KYC                                                                          ", "multisig-nokyc", "800400000cin", 0, MultisigInfo{"transfer-ownership", "multisig-acc-1", "multisig-nokyc", 0, nil, "grp-addr-4", 0, nil}, "MEMO : Transfer MultiSig Owner.", nil}, //
		...
		{"multiSig", true, true, "Create MultiSig Account - Error, due to without KYC", "multisig-nokyc", "800400000cin", 0, MultisigInfo{"create", "multisig-nokyc", "", 2, []string{"multisig-acc-1", "multisig-nokyc"}, "", 0, nil}, "MEMO : Create MultiSig Account", nil},
	}
