...
func makeMultisigTxs() []*testCase {
	...
	tcs := []*testCase{
		...
		{"multiSig", false, false, "MultiSig-create-tx-bank - Happy path       ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-1", 0, internalTx3}, "MEMO : MultiSig-create-tx-bank", nil},

		//Topic : create tx / sign tx
		{"multiSig", true, true, "case-1.1-Sign MultiSig Tx - Errr, due to All signers must pass kyc.																							 ", "multisig-acc-no-kyc", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-1", 0, internalTx3}, "MEMO : xxxx", nil}, //ok-20200316
		...
		{"multiSig", false, false, "case-1.1-Create MultiSig Tx - submit counter+1.															                                   ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-1", 1, internalTx3}, "MEMO : MultiSig-create-tx-bank - Resubmit counter+1", nil}, //ok-20200316
		{"multiSig", true, true, "case-1.1-Re-create MultiSig Tx - submit counter+1 - Error, due to Re-create Tx with same sequence			           ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-1", 1, internalTx3}, "MEMO : MultiSig-create-tx-bank", nil}, //ok-20200316
		{"multiSig", true, true, "case-1.1-Re-sign MultiSig Tx - Error for counter+1, due to already signed by multisig-acc-1 while create-tx-bank.", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-1", 1, internalTx3}, "MEMO : SignTx for counter+1.", nil}, //ok-20200316
		{"multiSig", false, false, "case-1.1-Create MultiSig Tx - submit counter+2.															                                   ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-1", 2, internalTx3}, "MEMO : MultiSig-create-tx-bank - Resubmit counter+2", nil}, //ok-20200316
		{"multiSig", true, true, "case-1.1-Re-create MultiSig Tx - submit counter+2 - Error, due to Re-create Tx with same sequence			           ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-1", 2, internalTx3}, "MEMO : MultiSig-create-tx-bank", nil}, //ok-20200316
		{"multiSig", true, true, "case-1.1-Re-sign MultiSig Tx - Error for counter+2, due to already signed by multisig-acc-1 while create-tx-bank.", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-1", 2, internalTx3}, "MEMO : SignTx for counter+2.", nil}, //ok-20200316
		...
		{"multiSig", false, true, "case-1.1-Delete MultiSig Tx - Error, due to 'Pending tx is not found' which ID : 3.       ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-1", 3, internalTx3}, "MEMO : Delete MultiSig Tx", nil}, //ok-20200316
		// {"multiSig", false, false, "case-1.1-Delete MultiSig Tx - Happy-path, due to the Valid PendingTx ID: 2. been found", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-1", 2, internalTx3}, "MEMO : Delete MultiSig Tx", nil},
		// {"multiSig", false, false, "case-1.1-Delete MultiSig Tx - Happy-path, due to the Valid PendingTx ID: 1. been found", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-1", 1, internalTx3}, "MEMO : Delete MultiSig Tx", nil},
		// {"multiSig", false, false, "case-1.1-Delete MultiSig Tx - Happy-path, due to the Valid PendingTx ID: 0. been found", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-1", 0, internalTx3}, "MEMO : Delete MultiSig Tx", nil},
		// {"multiSig", false, true, "case-1.1-Re-delete MultiSig Tx - Error, due to 'Pending tx is not found' which ID : 0. ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-1", 0, internalTx3}, "MEMO : Delete MultiSig Tx", nil},
		...
		{"multiSig", true, true, "MultiSig-sign-tx-bank - wrong sender       ", "mostafa", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-2", 0, internalTx4}, "MEMO : MultiSig-create-tx-bank", nil},
		...
		{"multiSig", false, false, "MultiSig-sign-tx-bank - Happy Path", "multisig-acc-2", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-2", 2, internalTx5}, "MEMO : MultiSig-sign-tx-bank", nil},
		{"multiSig", true, true, "MultiSig-sign-tx-bank - resubmit    ", "multisig-acc-2", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-2", 2, internalTx5}, "MEMO : MultiSig-sign-tx-bank", nil},
		...
		//Topic : delete tx - after 'Sign MultiSig Tx'
		{"multiSig", true, true, "case-2-Delete MultiSig Tx - Error, due to Group address invalid.                         ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-4", 0, internalTx5}, "MEMO : Delete MultiSig Tx", nil}, // ok-20200317
		{"multiSig", true, true, "case-2-Delete MultiSig Tx - Error, due to Only group account owner can remove pending tx.", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-2", 0, internalTx5}, "MEMO : Delete MultiSig Tx", nil}, // ok-20200317
		{"multiSig", false, true, "case-2-Delete MultiSig Tx - Error, due to 'Pending tx is not found' which ID : 9.       ", "multisig-acc-2", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-2", "", 0, nil, "grp-addr-2", 9, internalTx5}, "MEMO : Delete MultiSig Tx", nil}, // ok-20200317
		// {"multiSig", false, false, "case-2-Delete MultiSig Tx - Happy-path, due to the Valid PendingTx ID: 2. been found ", "multisig-acc-2", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-2", "", 0, nil, "grp-addr-2", 2, internalTx5}, "MEMO : Delete MultiSig Tx", nil},
		...
		//Topic : create tx
		{"multiSig", false, false, "case-3-Create MultiSig Tx - submit counter+0 - Happy Path commit.                            ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-3", 0, internalTx2}, "MEMO : xxxx", nil},
		{"multiSig", true, true, "case-3-Re-create MultiSig Tx - submit counter+0 - Error, due to Re-create Tx with same sequence", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"create-internal-tx", "", "", 0, nil, "grp-addr-3", 0, internalTx2}, "MEMO : MultiSig-create-tx-bank", nil}, //ok-20200316
		...
		{"multiSig", false, false, "case-3-Delete MultiSig Tx - Happy-path, due to the Valid PendingTx ID: 0. been found    ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-3", 0, internalTx2}, "MEMO : Delete MultiSig Tx", nil},
		{"multiSig", false, true, "case-3-Re-delete MultiSig Tx - Error, due to 'Pending tx is not found' which ID : 0.     ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-3", 0, internalTx2}, "MEMO : Delete MultiSig Tx", nil},
		...
		{"multiSig", true, true, "case-3-Sign MultiSig Tx - Error, due to All signers must pass kyc.                             ", "multisig-acc-no-kyc", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil}, // ok-20200317
		{"multiSig", true, true, "case-3-Sign MultiSig Tx - Error, due to Sender is not group account's signer.                  ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil},      // ok-20200317

		{"multiSig", true, true, "case-3-Sign MultiSig Tx - Error, due to already signed by multisig-acc-1                           ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil},                                        // ok-20200317
		{"multiSig", false, false, "case-3-Sign MultiSig Tx - submit counter+1 which signed by multisig-acc-3 - commit.              ", "multisig-acc-3", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil},                                        // ok-20200317
		{"multiSig", true, true, "case-3-Re-sign MultiSig Tx - Error, due to counter+1 already signed by multisig-acc-3              ", "multisig-acc-3", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil},                                        // ok-20200317
		{"multiSig", false, false, "case-3-Sign MultiSig Tx - submit counter+1 which signed by multisig-acc-4 - commit.              ", "multisig-acc-4", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil},                                        // ok-20200317
		{"multiSig", true, true, "case-3-Re-sign MultiSig Tx - Error, due to counter+1 already signed by multisig-acc-4              ", "multisig-acc-4", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil},                                        // ok-20200317
		{"multiSig", true, true, "case-3-Sign MultiSig Tx - Error, is Invalid as Sender multisig-acc-2 is not group account's signer after done the Update-MultiSig-Account.", "multisig-acc-2", "800400000cin", 0, MultisigInfo{"multiSig-sign-tx", "", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : xxxx", nil}, // ok-20200317

		//Topic : delete tx - after 'Sign MultiSig Tx'
		{"multiSig", false, false, "case-3-Delete MultiSig Tx - Happy-path, due to the Valid PendingTx ID: 1. been found                            ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : Delete MultiSig Tx", nil},
		{"multiSig", false, true, "case-3-Delete MultiSig Tx - Error, due to 'Pending tx is not found' which ID : 2.                  						  ", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-3", 2, internalTx2}, "MEMO : Delete MultiSig Tx", nil},
		{"multiSig", false, true, "case-3-Re-delete MultiSig Tx - Error, due to 'Pending tx is not found' which ID : 1. as this already been removed", "multisig-acc-1", "800400000cin", 0, MultisigInfo{"multiSig-delete-tx", "multisig-acc-1", "", 0, nil, "grp-addr-3", 1, internalTx2}, "MEMO : Delete MultiSig Tx", nil},
